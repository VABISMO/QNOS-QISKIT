...
| 2    | Sony IMX477 Camera Module           | U2        | IMX477 12.3MP (HQ Camera module)     | 1        | High-resolution fluorescence capture from hBN sites for ≥16 qubit discrimination  | M12 mount, 22-pin FFC         | 12.3MP sensor enables higher qubit density. 4056×3040 resolution allows scaling to 256+ sites. Use with C/CS-mount lens for adjustable focus. For N>15, higher resolution is critical. |
